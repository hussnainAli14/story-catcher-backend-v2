...
class StoryService:
    ...
    def format_outline_as_storyboard(self, outline: dict) -> str:
        ...
        Returns:
            str: Formatted storyboard text
        """
        try:
            storyboard_parts = []
            storyboard_parts.append("🌟 **Your Story Outline**\n")
            storyboard_parts.append("*Generated by VideoGen - You can edit this before generating your video*\n")
            ...
            storyboard_parts.append("\n\n💡 **Tip:** You can edit this storyboard above before generating your video!")
